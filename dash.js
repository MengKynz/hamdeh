...
©Created by Kynz`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
        ...
        if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              dashh.sendMessage(from, { contentText: 'ASTROBOT ORIGINAL ぽ', footerText: `🐣 𝐋𝐈𝐒𝐓 𝐌𝐄𝐍𝐔 🐣\n  \n✗⃝🐋 Groupmenu\n✗⃝🐋 Wibumenu\n✗⃝🐋 Ownermenu\n✗⃝🐋 Stickermenu\n✗⃝🐋 Gamemenu\n✗⃝🐋 Funmenu\n✗⃝🐋 Downloadmenu\n✗⃝🐋 Infomenu\n✗⃝🐋 Othermenu\n✗⃝🐋 18+ Menu\n✗⃝🐋 Islammenu\n✗⃝🐋 Randomtext\n✗⃝🐋 Moviemenu\n✗⃝🐋 Randomimage\n✗⃝🐋 Ephoto\n✗⃝🐋 Photoky\n✗⃝🐋 Textpro\n✗⃝🐋 Sewa\n  \n  \nspeed : ${latensie.toFixed(4)}\nRuntime : ${runtime(process.uptime())}\nGroup Chats : ${groups.length}\nPrivate Chats : ${privat.length}\nBaterai : ${baterai}% ${charger}\nTotal Chats : ${totalChat.length}\nPlatform : ${os.platform()}\n  \n ©Created by Kynz`, buttons: [{ buttonId: `${prefix}command`, buttonText: { displayText: 'MENU' }, type: 1 }, { buttonId: `${prefix}rules`, buttonText: { displayText: 'RULES' }, type: 1 }, { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }], headerType: 6, locationMessage: { degreesLatitude: 0, degreesLongitude: 0, jpegThumbnail: pi2 }}, 'buttonsMessage')
              break
              case 'bc3':
      case 'broadcast3':
             ...
             for (let _ of anu) {
             dashh.sendMessage(_.jid, { contentText: `*🌹 SIARAN ASTROBOT 🌹*\n\n${body.slice(4)}`, footerText: '©Created by Kynz', buttons: [{ buttonId: `${prefix}command`, buttonText: { displayText: 'MENU' }, type: 1 }, { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }], headerType: 6, locationMessage: { degreesLatitude: 0, degreesLongitude: 0, jpegThumbnail: bc2 }}, 'buttonsMessage')
}
...
`
sendButMessage(from, wibu, `©Created by Kynz`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
case 'chiisaihentai':
              ...
              buttonsMessage = {footerText:'©Created by Kynz', imageMessage: imageMsg,
      ...
      case 'broadcast2':
             ...
             for (let _ of anu) {
             dashh.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 SIARAN ASTROBOT 」*\n\n${body.slice(4)}`})
}
             reply('Suksess broadcast')
             } else {
             for (let _ of anu) {
dashh.sendMessage(_.jid, 
	    {"contentText": `*「 SIARAN ASTROBOT 」*\n\n${body.slice(4)}`,
	    "footerText": '©Created by Kynz',
	    "buttons": [
	    {"buttonId": `!owner`,
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
     ...
     if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
       titid =  `SILAHKAN PILIH DI BAWAH UNTUK MELANJUTKAN`
                   ...
                   sendButMessage(from, titid, `©Created by Kynz`, [
          {
            buttonId: `Y`,
            buttonText: {
              displayText: `Y`,
...
\`\`\`◧ Wa Version: ${dashh.user.phone.wa_version}\`\`\`
\`\`\`◧ Os Version: ${dashh.user.phone.os_version}\`\`\`
\`\`\`◧ Device Manufacturer: ${dashh.user.phone.device_manufacturer}\`\`\`
\`\`\`◧ Device Model: ${dashh.user.phone.device_model}\`\`\`
\`\`\`◧ Os Build Number: ${dashh.user.phone.os_build_number}\`\`\``
             reply(teks)
             break  
//------------------< Owner >-------------------
      case 'addupdate':
      ...
      case 'broadcast':
             ...
             bc = await dashh.downloadMediaMessage(encmedia)
             for (let _ of anu) {
             dashh.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 PESAN SIARAN BOT 」*\n\n${body.slice(4)}`})
}
             reply('Suksess broadcast')
             } else {
             for (let _ of anu) {
...
• Pemenangnya adalah [ @${winR} ] `
	   dashh.sendMessage(from, starGame, text, {quoted: das, contextInfo: { mentionedJid: [winR + "@s.whatsapp.net", gelutSkuy.Z + "@s.whatsapp.net", gelutSkuy.Y + "@s.whatsapp.net",]}})
		...
		dashh.sendMessage(from, `👑 Game Gelud Rejected 🤙🏻
